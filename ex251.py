...
match book:
    case (_, str(author), str(title), *_): #автор, название
        print('Yes')
    case (_, str(author), str(title), int(price) | float(price), *_): #автор, название, цена
        print('Yes')
    case (_, str(author), str(title), int(year), *_): #автор, название, год издания
        print('Yes')
    case (_, str(author), str(title), int(price) | float(price), int(year), *_): #автор, название, цена, год издания
        print('Yes')
    case _:
        print('No')
